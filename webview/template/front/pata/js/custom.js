...
var Pata = function(){
	...
	var dzTheme = function(){
		...
		jQuery('.location-btn a').on('click',function(){
			jQuery('.location-btn').toggleClass('active');
		});
		...
		jQuery(window).on('scroll', function () {
			if(jQuery('.sticky-header').length > 0){
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.header-transparent .container > .logo-header .logo-1').attr('src','images/logo.png');
					$('.header-transparent .container > .logo-header .logo-2').attr('src','images/logo-white-4.png');
				} else {
					menu.removeClass('is-fixed');
					$('.header-transparent .container > .logo-header .logo-2').attr('src','images/logo-white.png')
					$('.header-transparent .container > .logo-header .logo-2').attr('src','images/logo-white-3.png')
				}
			}
		});
